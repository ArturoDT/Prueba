...
<!-- Footer -->
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			...
		    			<p class="contact-us-details">
	        				<b>Address:</b> Ubicacion del Plantel<br/>
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			<h3>Conocenos en la redes Sociales</h3>
    ...
    <script src="js/tablaJS/config_datatable_api.js" type="text/javascript"></script>
</html>