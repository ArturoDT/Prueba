...
<form class="formoid-default-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:380px;min-width:150px;
    ...
    <div class="element-input">
        ...
        <input class="null" type="number" name="telefono" required="required" style="width: 350px" value="<%=filas[4]%>"/>
    </div>
    <div class="">
        ...
        <input class="null" type="number" name="celular" required="required" style="width: 350px" value="<%=filas[5]%>"/>
    </div>
