                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="FormularioCarrera.jsp">Carrera</a></li>
                                        <li><a href="FormularioCicloPerido.jsp">Ciclo-Periodo</a></li>
                                        <li><a href="CicloPeriodo.jsp">Grupos</a></li>
                                        <li><a href="FormularioHorarios.jsp">Horarios</a></li>
                                        <li><a href="FormularioPersonal.jsp">Personal</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="TablaAlumnos.jsp">Alumnos</a></li>
                                        <li><a href="TablaAsistencia.jsp">Asistencia</a></li>
                                        <li><a href="MostrarCarrera.jsp">Carrera</a></li>
                                        <li><a href="MostrarCicloPeriodo.jsp">Ciclo-Periodo</a></li>
                                        <li><a href="TablaGrupos.jsp">Grupos</a></li>
                                        <li><a href="TablaHorarios.jsp">Horarios</a></li>
                                        <li><a href="PruebaTabla.jsp">Historial</a></li>
                                        <li><a href="MostrarPersonal.jsp">Personal</a></li>
                                    </ul>
                                </li> 
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Asignar<i class="icon-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="MostrarGrupos.jsp">Grupo-Carrera</a></li>
                                    </ul>
                                </li> 
