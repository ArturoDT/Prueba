...
public final class FormularioDomicilioP_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    int nc = Integer.parseInt(request.getParameter("cedula"));
      ...
      out.write("    <div class=\"title\"><h2>Registro de domicilio Personal</h2></div>\n");
      ...
      out.write("                *</span>\n");
      out.write("        </label>\n");
      out.write("        <input  type=\"number\" name=\"ne\" required=\"required\" style=\"width: 250px\"/>\n");
      out.write("    </div>\n");
      out.write("    <div class=\"element-input\">\n");
        ...
        if (c.conectar()) {
            ...
            if (c.ejecutaSQL("Insert into domicilioalumnos values(null,'" + calle + "','" + ne + "','" + colonia + "','" + localidad + "','" + municipio + "','" + codpos + "')")) {
                ...
                if (res != null) {
                    ...
                    if (c.ejecutaSQL("Update personal set Id_Domicilio='" + id + "' where Cedula=" + nc)) {

      out.write("\n");
      out.write("<script>\n");
      out.write("    alertify.success(\"Registro Generado OK :)\");\n");
      out.write("    location.href = \"FormularioU.jsp?control=");
      out.print(nc);
      out.write("\";\n");
      out.write("</script>\n");
      out.write("\n");
