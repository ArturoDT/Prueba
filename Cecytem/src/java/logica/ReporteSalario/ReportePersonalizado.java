 ...
 * @author arturo
 */
@WebServlet(name = "ReportePersonalizado", urlPatterns = {"/ReportePersonalizado"})
public class ReportePersonalizado extends HttpServlet {
            ...
            /* TODO output your page here. You may use following sample code. */
                ...
                if (bd.conectar()) {
                    ResultSet resul = bd.consultas("Select asistencia.HoraE,"
                            ...
                            + "from alumno join asistencia on alumno.Control = asistencia.Id_alumno and alumno.Control="+control+" and asistencia.FechaE>='"+fechaI+"' and "
                            + " asistencia.FechaE<='"+fechaF+"' order by FechaE");
                    if (resul != null) {
